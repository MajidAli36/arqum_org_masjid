...
export const metadata = {
  title: "Request a Speaker | Darul Arqam Islamic Center",
  description:
    "Invite a qualified speaker from Darul Arqam Islamic Center for your school, college, faith group, or community organization.",
};
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14 lg:py-16">
            <div className="prose prose-sm max-w-none text-gray-800 sm:prose-base">
              ...
              <p>
                The members of Darul Arqm Islamic Center are available to
              ...
              <p>
                ...
                at Darul Arqm. Should you be interested in visiting our mosque,
